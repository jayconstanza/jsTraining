/* 
class Car {
    static #list = [{name: "car1", alias: "carch"},{name: "car2", alias: "carD"},{name: "car3", alias: "benzo"}];
  ...
  //way 1
  Car.getCarsOrderedBy("name").forEach((value, key) => console.log(JSON.stringify(value) + ` is assigned to key ${key}`))
  //way 2
